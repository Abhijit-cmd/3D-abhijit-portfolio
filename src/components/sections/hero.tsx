          ...
          {!isLoading && (
            <>
              <div className="">
                ...
                <BlurIn delay={1.2}>
                  <div className={cn(
                      "md:self-start md:mt-4 ml-3",
                      "font-thin text-md sm:text-xl md:text-xl whitespace-nowrap",
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={
                    "https://drive.google.com/file/d/1DL-_wLdolVFnV2wkeheevy24WA0PPRRp/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
